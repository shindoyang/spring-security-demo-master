package com.admission.security.common.entity;
...
public class JsonResult<T> implements Serializable {
    ...
    public JsonResult(boolean success, Integer code, String msg, T data) {
        this.success = success;
        this.code = success ? ResultCode.SUCCESS.getCode() : (code == null ? ResultCode.COMMON_FAIL.getCode() : code);
        this.msg = success ? ResultCode.SUCCESS.getMessage() : (msg == null ? ResultCode.COMMON_FAIL.getMessage() : msg);
        this.data = data;
    }
